...
static BLEUUID serviceUUID("FF19");  //remplacer le UUID par FFXX où XX est le numéro du HM10
...
std::string myDeviceName = "19-HM10-IDO";  //ÉCRIRE ICI le nom de votre HM-10, donc remplacer 00 par votre numéro
